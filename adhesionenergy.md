...
1. The first step is to load your image into ImageJ or Fiji and load the macro provided below. After downloading into the appropriate folder of your Imagej copy, you can find the macro using Plugin -> Macros in Imagej/Fiji. If you calibrate ImageJ to the correct pixel-size in µm you will later get the adhesion energy in units of J/µm^2.
